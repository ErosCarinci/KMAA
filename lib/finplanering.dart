...
class Finplanering extends StatefulWidget {
  const Finplanering({Key? key}) : super(key: key);

  @override
  _FinplaneringState createState() => _FinplaneringState();
}
...
class _FinplaneringState extends State<Finplanering> {
        ...
        child: FloatingActionButton(
          ...
          onPressed: () {
            ...
            showDialog(
              ...
              builder: (context) {
                return AlertDialog(
                  //change to CupertinoAlertDialog for IOS
